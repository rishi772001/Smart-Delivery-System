...
?>
            ...
            <button class='btn btn-outline-danger' style="float:right;"> <a href="index.html?logout='1'"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="text" name="addr"
                                style="border:none;border-bottom: 2px solid blue;background-color: #b7fff6"
