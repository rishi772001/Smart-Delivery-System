...
<body>
  <div class="content">
    ...
    <div class="container">
      ...
      <button style="float:right;margin-right: 10" class="btn btn-outline-danger"> 
      <a href="index.html?logout='1'" style="color: black;text-decoration: none;">logout</a> 
      </button>
      <p>Welcome <strong><?php echo $_SESSION['username']; echo "</br> Your Id:".$_SESSION['idd']; ?></strong>
      </p>
      <?php endif ?>
    </div>
  </div>
    ...
    <script>
      ...
      function initMap() {
        ...
        <?php
          ...
          $sql = "SELECT * from postt where ID='$userid'";
          ...
          if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  // add details for finding shortest path
      ...
      // adds marker in map for given latitue and longitude
      function addMarker(location) {
        var marker = new google.maps.Marker({
          <?php
            $la="<script>document.writeln(location['lat']);
            </script>";
            $lo="<script>
              document.writeln(location[pcs % quote~2 lngpcs % quote~2]);
            </script>";
            $pq=geo($la, $lo);
          ?>
    ...
    public function loadMatrix()
    {
        ...
        for ($i = 0; $i < $n_locations; $i++) {
            ...
            echo "<form method='POST'><pre>
                    <input type='hidden' value=".$add." name='inp'>
                      <button type='submit' value='Delivered' class='btn btn-success' name='del'>
                        Delivered
                      </button>
                      <br>
                    </pre>
