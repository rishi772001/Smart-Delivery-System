...
<div class="container">
    ...
    <?php  if (isset($_SESSION['username'])) : ?>
      <button style="float:right;margin-right: 10"> <a href="index.php?logout='1'" style="color: red;text-decoration: none;">logout</a> </button>
...
class TspBranchBound
{
  ...
  public function loadMatrix()
  {
    ...
    for ($i = 0; $i < $n_locations; $i++)
    {
      ...
      echo $i+1 . ". " . $address;echo "<form method='POST'><pre><input type='hidden' value=".$add." name='inp'><button type='submit' value='Delivered' style='color:green;' name='del'>Delivered</button><br></pre></form>";
